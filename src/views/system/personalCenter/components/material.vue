    ...
    <div class="header">
      <el-form :inline="true"
        ...
        <el-form-item label="申请单号"
          label-width="70px">
          <el-input v-model="form.singleCode" style="width:150px;"
            clearable></el-input>
        </el-form-item>
        <el-form-item label="状态"
          label-width="50px">
          <el-select v-model="form.status" style="width:150px;" clearable
            placeholder="请选择">
...
export default {
  ...
  methods: {
    ...
    initData () {
      this.$api.personalCenter.getMessageBySingleAndStatusList({ pageNum: this.page, pageSize: this.limit, singleCode: this.form.singleCode, source: '1', status: this.form.status }).then(res => {
        if (res.code === 200) {
